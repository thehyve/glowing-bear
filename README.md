...
The latest release is [glowing-bear-1.3.6.tar](https://repo.thehyve.nl/service/local/repositories/releases/content/nl/thehyve/glowing-bear/1.3.6/glowing-bear-1.3.6.tar).
