...
The latest release is [glowing-bear-2.0.7.tar](https://repo.thehyve.nl/service/local/repositories/releases/content/nl/thehyve/glowing-bear/2.0.7/glowing-bear-2.0.7.tar).
