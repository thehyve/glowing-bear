...
The latest release is [glowing-bear-2.0.0.tar](https://repo.thehyve.nl/service/local/repositories/releases/content/nl/thehyve/glowing-bear/2.0.0/glowing-bear-2.0.0.tar).
