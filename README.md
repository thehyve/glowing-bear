...
The latest release is [glowing-bear-0.8.1.tar](https://repo.thehyve.nl/service/local/repositories/releases/content/nl/thehyve/glowing-bear/0.8.1/glowing-bear-0.8.1.tar).
