...
The latest release is [glowing-bear-1.0.1.tar](https://repo.thehyve.nl/service/local/repositories/releases/content/nl/thehyve/glowing-bear/1.0.1/glowing-bear-1.0.1.tar).
