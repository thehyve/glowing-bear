...
describe('GbMedcoResultsComponent', () => {
  let component: GbExploreResultsComponent;
  let fixture: ComponentFixture<GbExploreResultsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GbExploreResultsComponent);
