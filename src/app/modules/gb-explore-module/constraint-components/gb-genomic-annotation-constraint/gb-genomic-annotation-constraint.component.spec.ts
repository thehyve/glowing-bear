...
import {GbGenomicAnnotationConstraintComponent} from './gb-genomic-annotation-constraint.component';
...
describe('GbGenomicAnnotationConstraintComponentTs', () => {
  let component: GbGenomicAnnotationConstraintComponent;
  let fixture: ComponentFixture<GbGenomicAnnotationConstraintComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GbGenomicAnnotationConstraintComponent);
