...
import {I2b2Item} from "../../models/picsure-models/i2b2-medco/i2b2-item";
...
@Injectable()
export class PicsureMappingService {

  constructor(private medcoService: MedcoService) { }

  public mapI2b2MedCoConstraint(constraint: Constraint): I2b2Panel[] {
    ...
    switch (constraint.concept.type) {
      ...
      case ConceptType.SIMPLE:
        if (constraint.concept.encryptionDescriptor.encrypted) {
          ...
          item.queryTerm = this.medcoService.encryptInteger(String(constraint.concept.encryptionDescriptor.id));
